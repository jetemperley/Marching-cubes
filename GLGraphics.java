...
/*
    The purpose of this class is to encapsulate all graphical drawing actions and management into a single class (irrespective of where it is being drawn)
    eg. drawing and manipulating meshes and animations, manage their vertex data, managing the camera, and associated rendering programs
    additionally this class should programatically implement 'primitve' shapes like cubes etc.
    Some specialty methods have been added, like for seting up specific cube renderers
*/

// TODO decouple from JOGL objects, like Matrix4, replace with arrays
...
public class GLGraphics {
    ...
    void initShadowProg(GL4 g) {
        ...
        g.glTexImage2D(GL4.GL_TEXTURE_2D, 0, GL4.GL_DEPTH_COMPONENT32, 0, 0, 0, GL4.GL_DEPTH_COMPONENT, GL4.GL_FLOAT,
                null);
