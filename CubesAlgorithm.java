...
static class CubesAlgorithm {
    
    // takes a byte which each bit refers to the presence of a vertex
    // and returns the corresponding indexed trangle topology
    // i.e. gives you back the triangles to draw
    static byte[] getTris(byte verts){
        int edges = VERT_REF[verts];
        return null;
    }

    static float[] calcTris(){

        ArrayList<Byte> tris = new ArrayList<Byte>();


        return null;
    }

    final static float[][] VERTICIES = new float[][] {
        {-0.5f, 0.5f, -0.5f},
        {0.5f, 0.5f, -0.5f},
        {0.5f, -0.5f, -0.5f},
        {-0.5f, -0.5f, -0.5f},
    ...
    public final byte[][] EDGES = new byte[][] {
        {0, 1}, {1, 2}, {2, 3}, {3, 0},
        {4, 5}, {5, 6}, {6, 7}, {7, 4}
    };

    // this table converts the active verticies data (a byte referencing cube verts 1 active, 0 inactive) to a TRIANGLES reference 
    public final static int[] VERT_REF = new int[] { 
    ...
    // these are edge indicies used to draw triangles
    public final static int[][] EDGE_REF = new int[][] {
        {},
        {0, 8, 3, },
        {0, 1, 9, },
        {1, 8, 3, 9, 8, 1, },
